...
from apps.panel.admin_inlines import MediaInline, SliceInline
from .admin_inlines import SliceInline
...
class PageAdmin(DraggableMPTTAdmin):
    inlines = [MediaInline, SliceInline] 
    inlines = [SliceInline]
...
class MediaAdmin(admin.ModelAdmin):
    list_display = ('file', 'file_type', 'file_size', 'uploaded_at')
    search_fields = ('file',)
