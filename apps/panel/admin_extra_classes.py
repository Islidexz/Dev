# c:/Users/User/Desktop/Nest/DEV/apps/panel/admin_extra_classes.py
from django.contrib import admin
from apps.panel.models import Slice, Page, Website
from apps.panel.models_extra import Media, TextContent, Template, Set, SEOData
...
#салоны красоты маникюр рядом с Выхино
